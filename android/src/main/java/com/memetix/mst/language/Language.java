...
public enum Language {
    ...
    public String getName(Language locale) throws Exception {
        ...
        if (this.localizedCache.containsKey(locale)) {
            ...
            if (this == Language.AUTO_DETECT || locale == Language.AUTO_DETECT) {
                ...
                String[] names = new LanguageService().execute(Language.values(), locale);
                int i = 0;
    ...
    public  List<String> getLanguageCodesForTranslation() throws Exception {
        String[] codes = new GetLanguagesForTranslateService().execute();
    ...
    private final class LanguageService extends MicrosoftTranslatorAPI {
    ...
    private final class GetLanguagesForTranslateService extends MicrosoftTranslatorAPI {
